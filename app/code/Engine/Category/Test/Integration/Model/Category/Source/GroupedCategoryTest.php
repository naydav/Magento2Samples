...
use Engine\Category\Model\Category\Source\GroupedCategory;
use Magento\TestFramework\Helper\Bootstrap;

/**
 * @author  naydav <valeriy.nayda@gmail.com>
 */
class GroupedCategoryTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var GroupedCategory
     */
    ...
    protected function setUp()
    {
        ...
        $this->groupedCategorySource = Bootstrap::getObjectManager()->create(GroupedCategory::class);

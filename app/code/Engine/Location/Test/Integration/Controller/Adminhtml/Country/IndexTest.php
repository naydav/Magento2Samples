...
class IndexTest extends AbstractBackendController
{
    ...
    {
        $this->dispatch('backend/engine-location/country');
        ...
        AssertPageTitle::assert($body, __('Manage Countries'));
        AssertPageHeader::assert($body, __('Manage Countries'));
        AssertAddButton::assert($body, 'add-button');
        AssertListing::assert($body, 'engine_location_country_listing');
    }
}

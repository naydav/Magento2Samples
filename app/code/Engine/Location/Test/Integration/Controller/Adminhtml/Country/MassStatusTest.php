...
class MassStatusTest extends AbstractBackendController
{
     ...
     * Request uri
     */
    const REQUEST_URI = 'backend/engine-location/country/massStatus';
    ...
    public function testMassStatus()
    {
        ...
        $this->assertSessionMessages(
            $this->contains('You updated 1 Country(s).'),
            MessageInterface::TYPE_SUCCESS
        );
        self::assertEquals(1, $this->getEnabledCountriesCount());
    }
    ...
    public function testMassStatusWithWrongRequestMethod()
    {
        ...
        self::assertEquals(2, $this->getEnabledCountriesCount());
    }
     ...
     * @return int
     */
    private function getEnabledCountriesCount(): int
    {
        /** @var SearchCriteriaBuilder $searchCriteriaBuilder */
        $searchCriteriaBuilder = $this->searchCriteriaBuilderFactory->create();
        $searchCriteria = $searchCriteriaBuilder
            ->addFilter(CountryInterface::ENABLED, true)
            ->create();
